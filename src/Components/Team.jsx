    ...
    return (
        <div className='bg-[#f6f6f6] z-[-10] py-[50px] pb-[100px]'>
            <div className='p-10'>
                ...
                <div id='profiles' className='flex justify-center gap-[200px] relative mt-10 h-100 mb-10'>
                    <div id="profile-1" className='relative z-10'>
                        <div className='relative z-20 left-10'>
                            <img src={person1} alt='person-1' />
                        </div>
                        <div className='bg-white w-[400px] h-[350px] absolute top-13 p-12 pt-0 rounded-full rounded-bl-none flex flex-col justify-end'>
                    ...
                    <div id="profile-2" className='relative z-10'>
                        <div className='relative z-20 left-10'>
                            <img src={person2} alt='person-2' />
                        </div>
                        <div className='bg-white w-[400px] h-[350px] absolute top-30 p-12 pt-0 rounded-full rounded-bl-none flex flex-col justify-end'>
                    ...
                    <div id="profile-3" className='relative z-10'>
                        <div className='relative z-20 left-10'>
